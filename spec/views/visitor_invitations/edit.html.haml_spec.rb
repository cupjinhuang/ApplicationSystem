...
describe "visitor_invitations/edit" do
  before(:each) do
  ...
  it "renders the edit visitor_invitation form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", visitor_invitation_path(@visitor_invitation), "post" do
