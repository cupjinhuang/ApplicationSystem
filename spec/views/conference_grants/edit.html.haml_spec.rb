...
describe "conference_grants/edit" do
  before(:each) do
  ...
  it "renders the edit conference_grant form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", conference_grant_path(@conference_grant), "post" do
